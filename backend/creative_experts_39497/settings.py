"""
Django settings for creative_experts_39497 project.
...
ROOT_URLCONF = 'creative_experts_39497.urls'
...
WSGI_APPLICATION = 'creative_experts_39497.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "creative_experts_39497 API",
    "DESCRIPTION": "API documentation for creative_experts_39497 App",
    "VERSION": "v1",
}
